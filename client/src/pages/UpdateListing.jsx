...
export default function CreateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
        try {
            const response = await fetch(`/server/listing/getListing/${params.listingID}`); // listingID is the parameter that we get from the url. It is defined in the App.js file
